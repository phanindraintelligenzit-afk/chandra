...
def audit_log(agent: str, action: str, output: object) -> None:
    """Emit a structured audit event for an agent action."""
    log = {
    ...
    get_logger("chandra.audit").info(json.dumps(log, default=str))
