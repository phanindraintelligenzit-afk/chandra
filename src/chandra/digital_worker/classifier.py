...
_SERVICE_PLATFORM: dict[str, CloudPlatform] = {
    # AWS
    "ec2": CloudPlatform.AWS,
    "s3": CloudPlatform.AWS,
    "rds": CloudPlatform.AWS,
    "lambda": CloudPlatform.AWS,
    "iam": CloudPlatform.AWS,
    "vpc": CloudPlatform.AWS,
    "cloudwatch": CloudPlatform.AWS,
    "cloudtrail": CloudPlatform.AWS,
    "dynamodb": CloudPlatform.AWS,
    "eks": CloudPlatform.AWS,
    "ecs": CloudPlatform.AWS,
    "elb": CloudPlatform.AWS,
    "alb": CloudPlatform.AWS,
    "sqs": CloudPlatform.AWS,
    "sns": CloudPlatform.AWS,
    "ebs": CloudPlatform.AWS,
    "efs": CloudPlatform.AWS,
    "route53": CloudPlatform.AWS,
    "cloudfront": CloudPlatform.AWS,
    "guardduty": CloudPlatform.AWS,
    "redshift": CloudPlatform.AWS,
    "elasticache": CloudPlatform.AWS,
    "kms": CloudPlatform.AWS,
    # Azure
    "aks": CloudPlatform.AZURE,
    "cosmosdb": CloudPlatform.AZURE,
    "app-service": CloudPlatform.AZURE,
    "blob": CloudPlatform.AZURE,
    "azure-functions": CloudPlatform.AZURE,
    "vnet": CloudPlatform.AZURE,
    "azure-sql": CloudPlatform.AZURE,
    "keyvault": CloudPlatform.AZURE,
    # GCP
    "gke": CloudPlatform.GCP,
    "bigquery": CloudPlatform.GCP,
    "cloud-run": CloudPlatform.GCP,
    "gcs": CloudPlatform.GCP,
    "cloud-functions": CloudPlatform.GCP,
    "cloud-sql": CloudPlatform.GCP,
    "pubsub": CloudPlatform.GCP,
    # Kubernetes
    "kubernetes": CloudPlatform.KUBERNETES,
    "k8s": CloudPlatform.KUBERNETES,
    "pod": CloudPlatform.KUBERNETES,
    "pods": CloudPlatform.KUBERNETES,
    "deployment": CloudPlatform.KUBERNETES,
    "helm": CloudPlatform.KUBERNETES,
    "kubectl": CloudPlatform.KUBERNETES,
    "namespace": CloudPlatform.KUBERNETES,
    "ingress": CloudPlatform.KUBERNETES,
    "statefulset": CloudPlatform.KUBERNETES,
}
