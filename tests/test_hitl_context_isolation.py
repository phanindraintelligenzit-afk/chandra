...
def _get_shared_checkpointer():
    global _SHARED_CHECKPOINTER  # noqa: PLW0603
...
class TestRealBug(unittest.TestCase):
    ...
    def test_bug_reproduced_with_separate_checkpointers(self):
        ...
        try:
            ...
            print(
                f"   BUG test: Resume result action='{action_val}' result='{final.values.get('result')}'"  # noqa: E501
            )
    ...
    def test_exec_prefix_no_collision(self):
        ...
        print(
            f"PASS: No collision — parent='{parent_snap.values['action']}', child='{child_snap.values['action']}'"  # noqa: E501
        )
