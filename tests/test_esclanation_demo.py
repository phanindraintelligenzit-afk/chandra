...
for i, escalation in enumerate(escalations, 1):
    print()
    print("{}. {} - {}".format(i, escalation["severity"], escalation["service"]))
    print("   Finding ID: {}".format(escalation["finding_id"]))
    print("   Resource: {}".format(escalation["resource_id"]))
    print("   Summary: {}".format(escalation["summary"]))
    print("   Action: {}".format(escalation["recommended_action"]))
    print("   Published: {}".format(escalation["timestamp"]))
