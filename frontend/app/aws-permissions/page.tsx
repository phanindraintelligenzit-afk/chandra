...
const PREDEFINED_TEMPLATES: Template[] = [
  {
    ...
    description: "Read-only access to S3 buckets — list, get objects",
    aws_service: "S3",
    actions: ["s3:ListBucket", "s3:GetObject", "s3:GetObjectVersion"],
    resource_arn: "arn:aws:s3:::*",
  },
  {
    name: "EC2 Full Management",
  ...
  {
    name: "Lambda Invoke Only",
    description: "Invoke Lambda functions — no management",
    aws_service: "Lambda",
    actions: ["lambda:InvokeFunction", "lambda:InvokeAsync", "lambda:GetFunction"],
    resource_arn: "arn:aws:lambda:*:*:function:*",
  },
  {
    name: "IAM Read-Only Auditor",
    description: "Read-only IAM auditing access",
    aws_service: "IAM",
    actions: [
      "iam:ListUsers",
      "iam:ListRoles",
    ...
    resource_arn: "arn:aws:iam::*:role/*",
  },
  {
    name: "DynamoDB CRUD",
    description: "Full CRUD on DynamoDB tables",
    ...
    resource_arn: "arn:aws:dynamodb:*:*:table/*",
  },
  {
    name: "SQS Producer/Consumer",
